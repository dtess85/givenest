const steps = [
  ...
  },
  {
    ...
    desc: "Select any charity in the country. Your choice is tied to your transaction and tracked on our dashboard.",
    link: { label: "Browse charities", href: "/charities" },
  },
  {
    number: "03",
    title: "Choose your agent",
    desc: "Work with any agent. They handle the deal—we make the donation.",
  ...
  return (
    ...
    <div className="bg-coral px-8 py-[18px]">
      <div className="mx-auto max-w-[960px]">
        ...
        <Link href="/about" className="text-[15px] font-semibold tracking-[-0.01em] text-white underline underline-offset-2 hover:opacity-70 transition-opacity">
